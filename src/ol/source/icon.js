...
ol.source.IconLabel.prototype = Object.create(ol.source.Vector.prototype);

ol.source.IconLabel.prototype.addFeatureInternal = function(feature) {
...
ol.source.IconLabel.prototype.loadFeatures = function(extent, resolution, projection) {
 ...
 */
ol.source.IconLabel.prototype.buildQuery = function(params){
